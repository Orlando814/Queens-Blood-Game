...
/**
 * will check and will only allow fthe the algorithm to place a card at row 2 and col 3, indexed
 * from 0.
 */
public class SanguineOnlyAllowsMovesToRowTwoColThree implements Sanguine {
   ...
   */
  public SanguineOnlyAllowsMovesToRowTwoColThree(Appendable log, Sanguine model) {
